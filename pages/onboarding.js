...
const slides = [
    ...
    },
    {
        ...
        desc: '챔피언십에서 20개 필터를 조절해서 자신만의 번호를 뽑아보세요!',
        button: '시작하기'
    }
];
            ...
            <div className="relative flex min-h-screen w-full flex-col max-w-[430px] mx-auto bg-background shadow-2xl">
                ...
                <div className="flex-1 flex flex-col px-6 justify-center pb-20">
                    ...
                    <div className="w-full aspect-square max-h-[300px] mb-12 relative flex items-center justify-center">
                        ...
                        <div className="relative z-10 size-32 bg-gradient-to-tr from-card-gray to-surface rounded-full border border-themed-light flex items-center justify-center shadow-2xl">
                ...
                <div className="p-6 flex flex-col gap-8 pb-12">
                    ...
                    <div className="flex gap-2 justify-center">
                        {slides.map((_, idx) => (
                            <div
                                key={idx}
                                className={`h-1.5 rounded-full transition-all duration-300 ${currentSlide === idx ? 'w-8 bg-white' : 'w-2 bg-btn-secondary'}`}
                            />
                        ))}
                    </div>
                    ...
                    <button
                        ...
                        className={`w-full py-4 rounded-xl font-bold text-base active:scale-95 transition-all ${isLast
                                ...
                                : 'bg-card-gray text-t-primary border border-themed-light hover:bg-card-hover'
                            }`}
                    >
                        {slide.button}
                    </button>
