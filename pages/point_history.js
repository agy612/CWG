...
const TRANSACTIONS = [
    { id: 1, type: 'earn', icon: 'photo_camera', label: '낙첨 티켓 스캔', sub: '제1159회 · 한국 로또 6/45', amount: +75, date: '2026-02-28', tag: '스캔' },
    { id: 2, type: 'earn', icon: 'smart_display', label: '광고 보너스', sub: '스캔 보너스 광고 시청', amount: +25, date: '2026-02-28', tag: '보너스' },
    { id: 3, type: 'use', icon: 'emoji_events', label: '챔피언십 번호 생성', sub: '제1159회 · 트렌드 전략', amount: -100, date: '2026-02-27', tag: '챔피언십' },
    { id: 4, type: 'earn', icon: 'photo_camera', label: '낙첨 티켓 스캔', sub: '제1158회 · 한국 로또 6/45', amount: +75, date: '2026-02-21', tag: '스캔' },
    { id: 5, type: 'use', icon: 'lock_open', label: 'CWG 픽 열람', sub: '제1158회 · 10세트 열람', amount: -200, date: '2026-02-21', tag: '픽생성' },
    { id: 6, type: 'earn', icon: 'photo_camera', label: '낙첨 티켓 스캔', sub: '제1157회 · 한국 로또 6/45', amount: +75, date: '2026-02-14', tag: '스캔' },
    { id: 7, type: 'use', icon: 'emoji_events', label: '챔피언십 번호 생성', sub: '제1157회 · 수학 전략', amount: -100, date: '2026-02-14', tag: '챔피언십' },
    ...
    { id: 10, type: 'earn', icon: 'photo_camera', label: '낙첨 티켓 스캔', sub: '제1155회 · 한국 로또 6/45', amount: +50, date: '2026-01-25', tag: '스캔' },
];
...
const TAG_COLOR = (tag) => {
    const map = {
        ...
        '챔피언십': 'bg-purple-500/15 text-purple-400',
