...
export default function ChampionshipHistory() {
    ...
    return (
        <div className="bg-[#0a0a0a] font-sans text-t-primary antialiased min-h-screen">
            <Head><title>CWG - 럭키이벤트 히스토리</title></Head>
                ...
                <div className="px-6 flex flex-col gap-3">
                    {HISTORY.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-20 gap-4">
                            ...
                            <p className="text-t-dim text-sm font-semibold text-center">아직 생성한 번호가 없습니다.<br/>럭키이벤트 탭에서 번호를 생성해보세요!</p>
                            <button
                                onClick={() => router.back()}
                        ...
                        HISTORY.map(item => {
                            ...
                            return (
                                ...
                                >
                                    <button
                                        className="w-full p-5 flex flex-col gap-3 active:bg-white/5 transition-colors text-left"
