...
const coupons = [
    ...
    { id: 2, type: 'TICKET', title: '챔피언십 1회 무료', desc: '나만의 번호 생성 1회 무료', expiry: '2026-02-28', status: 'ACTIVE', icon: 'confirmation_number' },
                            ...
                            <div
                                ...
                                className={`relative bg-card-gray rounded-3xl p-6 border flex flex-col gap-4 overflow-hidden transition-all ${
                                    coupon.status === 'ACTIVE'
                                        ? 'border-themed-light hover:border-themed-medium cursor-pointer group'
