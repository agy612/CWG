...
const FAQS = [
    ...
    {
        q: 'CWG 픽은 무엇인가요?',
        a: 'CWG가 자동 생성하는 매주 10세트의 추천 번호입니다. 이전 당첨 이력과 통계를 분석하여 생성됩니다. FREE 회원은 200P로 1회 열람, 구독자는 무제한 열람 가능합니다.',
    },
    {
        q: '챔피언십이란 무엇인가요?',
        a: '35가지 필터를 직접 조정하여 나만의 전략으로 번호를 생성하는 기능입니다. 빈도, 패턴, 수학, 히스토리, 개인 설정 등 5개 카테고리의 필터를 조합할 수 있습니다. FREE 100P, STANDARD 100P, PRO 일 1회 무료 + 50P입니다.',
    },
    {
    ...
    },
    {
        ...
        a: '아니요. 포인트는 앱 내 CWG 픽 열람, 챔피언십 번호 생성, 포인트샵 상품 구매에만 사용 가능하며 현금으로 환전되지 않습니다. 포인트는 마지막 획득일로부터 12개월 후 소멸됩니다.',
    },
    {
    ...
    {
        q: '해외 복권도 스캔할 수 있나요?',
        a: '현재 한국 로또 6/45, 일본 로토6, 유럽 EuroMillions, Eurojackpot 총 4종을 지원합니다. 로또 선택 화면에서 해당 복권을 선택 후 스캔하세요.',
    },
];
                    ...
                    <div className="flex flex-col gap-2">
                        {FAQS.map((faq, idx) => (
                            <div key={idx} className="bg-card-gray rounded-2xl border border-themed overflow-hidden">
                                <button
                                    className="w-full px-5 py-4 flex items-center justify-between gap-3 text-left active:bg-card-hover transition-colors"
