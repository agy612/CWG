...
const TIER_STYLE = {
    ...
    FREE:     { bg: 'bg-zinc-600',         text: 'text-white',     dot: 'bg-zinc-300' },
    STANDARD: { bg: 'bg-white/20',         text: 'text-white',     dot: 'bg-white'    },
...
export default function DevTierSwitcher() {
    ...
    return (
        <div className="fixed top-4 right-3 z-[9999] flex flex-col items-end gap-2">
            ...
            {/* Panel */}
            {open && (
                <div className="bg-surface border border-themed-light rounded-2xl p-4 shadow-2xl min-w-[180px]">
                    ...
                    <div className="mt-3 border-t border-themed pt-3 flex flex-col gap-1.5">
                        ...
                        {[
                            ...
                            <button
                                key={route}
                                onClick={() => { router.push(route); setOpen(false); }}
